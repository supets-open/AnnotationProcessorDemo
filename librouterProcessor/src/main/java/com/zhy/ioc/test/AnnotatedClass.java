...
class AnnotatedClass {
    private static class TypeUtil {
        static final ClassName BINDER = ClassName.get("com.supets.annotationprocessordemo.processor2", "ViewBinder");
        static final ClassName PROVIDER = ClassName.get("com.supets.annotationprocessordemo.processor2", "ViewFinder");
    }
